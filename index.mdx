...
<div className="mx-auto flex w-full max-w-5xl flex-col gap-14 px-4 py-12 lg:py-16">
  ...
  <div className="flex flex-col gap-4">
    ...
    <Card
      ...
      cta="Read guide"
    >
      Rewrite lessons in your voice with AI-powered editing
    </Card>
    <Card
      title="Payments"
      icon="credit-card"
      ...
      cta="Read guide"
    >
      Connect Stripe, sell offers, and track revenue
    </Card>
    <Card
      title="API reference"
      icon="code-xml"
  ...
  <Columns cols={2} className="suggested-articles">
    ...
    <Card
      ...
      cta="Read article"
    >
      Use natural language commands to rewrite lessons in your own voice.
    </Card>
    <Card
      ...
      cta="Read article"
    >
      Link your Stripe account and sell single courses, bundles, or the Academy Pass.
    </Card>
    <Card
