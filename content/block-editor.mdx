...
Type `/` at the start of any line to open the block menu. Start typing the name of the block you want and press **Enter** to insert it. To move a block, grab the drag handle on its left edge and drop it where you want it. The drag handle also opens a menu with **Duplicate** and **Delete** for the block.
