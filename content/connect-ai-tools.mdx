...
<CardGroup cols={2}>
  ...
  <Card title="Ready-made prompts" icon="wand-magic-sparkles">
    Use built-in prompts to draft a new lesson, critique an existing one, or expand every stub in a course outline.
  </Card>
</CardGroup>
...
<Warning>
  Edits made through a connected tool follow the same forking rules as the built-in AI editor. The first time a library lesson is edited, Fayne forks it into your own private copy and it stops receiving master updates. See [AI Customization](/content/ai-customization) for how forking works.
</Warning>
