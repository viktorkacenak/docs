...
<Tabs>
  <Tab title="PDFs">
    Upload up to **2 PDFs** per generation, each up to **150 pages** and **25 MB**. Password-protected PDFs are not supported: remove the password and re-upload.
  </Tab>
