...
<AccordionGroup>
  <Accordion title="Which plans can generate courses">
    AI course generation is included on every plan, the preview trial included. What limits you in practice is your AI credit pool: the trial's 10 one-time credits cover roughly one full course, and paid plans refill every billing period (Pro 100, Scale 300).
  </Accordion>
