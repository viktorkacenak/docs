...
<Note>
  AI course generation runs on AI credits and is included on every plan, the free preview trial included (the trial's one-time pool of 10 credits covers roughly one full course). See [AI credits and access](#ai-credits-and-access) below.
</Note>
