...
<Info>
  A widget works only inside its lesson and cannot read information from the rest of your academy. Student inputs stay inside that interaction unless the widget itself clearly shows otherwise.
</Info>
