...
| `402` | `academy_locked` | The academy is paused — reactivate the plan to use the API |
| `402` | `trial_api_unavailable` | API access requires a paid plan — preview/trial academies cannot use the API |
| `402` | `limit_exceeded` | A plan limit was reached (for example, the student cap when adding a student) |
