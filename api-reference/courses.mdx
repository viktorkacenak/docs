    ...
    <ResponseField name="courses" type="object[]" required>
      ...
      <Expandable title="course properties" defaultOpen>
        ...
        <ResponseField name="access" type="string" required>
          The course's access mode. `free` means any member of your academy can open it. `offer_only` means it stays locked unless something grants it: a purchase, a course assignment, or an offer the student holds.
        </ResponseField>
