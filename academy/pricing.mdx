...
<CardGroup cols={2}>
  ...
  <Card title="Bundles" icon="boxes">
    Sell several courses as one product with its own name, cover, and shareable product page. Charge once or monthly. See [Offers](/payments/offers).
  </Card>
