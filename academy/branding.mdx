...
<Note>
  Customize groups its settings into two sections: **Branding** (identity, domain, colors, thumbnails, lessons, certificate) and **Pages** (course catalog, About page).
</Note>
...
Your academy's `fayneos.com` subdomain is set under **Domain** in the **Branding** section. Choose a subdomain made of lowercase letters, numbers, and hyphens. This subdomain powers your student landing page, your course detail pages, and your authentication screens.
...
The **Pages** section of Customize is where your visitor-facing pages live. Click **About page** to open the full-screen builder for your academy's landing page (the page visitors see first at `/about`). See the [About Page](/academy/about-page) guide for the full walkthrough.

Also under **Pages**, the **Course catalog** panel lets you choose your catalog layout (full width or floating).

## Email sender identity

Transactional emails from your academy are sent under your academy's own sender name, not Fayne's. This covers emails like signup confirmation, magic link sign-in, one-time passcode, course access notifications, and academy access changes. Your sender name is configured in your academy's email settings.
...
<AccordionGroup>
  ...
  <Accordion title="What email flows use my sender identity?">
    Transactional emails use your sender name, including signup confirmation, magic link sign-in, one-time passcode, course assigned, course access revoked, and academy access removed.
  </Accordion>

  <Accordion title="Can I update my branding after I launch?">
    Yes. Changes take effect immediately. Students who reload the page see the updated branding. There is no re-publishing step for these settings. (Your About page is the exception: it has its own Publish button.)
  </Accordion>
</AccordionGroup>