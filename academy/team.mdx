...
On Starter, Pro, or trial, the Team page shows a "Team members are a Scale feature" message and no invite form. Upgrade to Scale to start inviting collaborators. See [Plans and billing](/billing/plans) for the full comparison.
