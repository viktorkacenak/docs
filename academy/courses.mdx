...
<Note>
  Categories only organize your catalog; they never grant access. To control who can open a course, set its access to free, paid, or members-only (see [Pricing Models](/payments/pricing-models)) or cover it with an [offer](/payments/offers). Students see your catalog grouped by these categories on your courses page.
</Note>
