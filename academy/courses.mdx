...
<CardGroup cols={2}>
  ...
  <Card title="Category" icon="layers">
...
<AccordionGroup>
  ...
  <Accordion title="Can I remove a course from my academy?">
    Yes. Open the course in your dashboard and select **Delecte course**. Students who are already enrolled will lose the access immediately
  </Accordion>
</AccordionGroup>