...
<Warning>
  The selling currency **locks permanently after your first sale**, so decide before you start selling. The switch is also unavailable while fixed-amount [coupons](/payments/coupons) are active, because those coupons carry a specific currency.
</Warning>
