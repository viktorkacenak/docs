...
<Note>
  You only need to connect Stripe if you plan to sell paid courses. If all of your courses are free, you can skip this step entirely.
</Note>
...
Stripe's own processing fees apply separately and are set by Stripe.

## Revenue dashboard

Your owner dashboard includes a revenue summary under **Payments** and **Insights** that gives you a quick view of how your academy is performing financially.
