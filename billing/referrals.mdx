...
<CardGroup cols={2}>
  <Card title="You are the primary owner" icon="shield-check">
    The referral program is shown only to the academy's primary owner. Team members and other roles do not see the page.
  </Card>
...
You have one permanent referral code, shared across all academies on your account. The page shows it as a ready-to-share link.
